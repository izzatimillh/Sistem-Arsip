            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped" id="table-datatable">
                ...
                <tbody>
                  ...
                  include '../koneksi.php';
                  $no=1;
                  $peringatan = mysqli_query($koneksi,"SELECT * FROM peringatan,mahasiswa,pengurus where peringatan_mahasiswa=mahasiswa_id and peringatan_pengurus=pengurus_id");
