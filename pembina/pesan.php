        ...
        <div class="box box-solid">
          ...
          <div class="box-body no-padding">
            <ul class="nav nav-pills nav-stacked">
              <li class="active"><a href="pesan.php"><i class="fa fa-inbox"></i>Pesan Masuk</a></li>
            ...
            <div class="table-responsive mailbox-messages">
              <table class="table table-hover table-striped" id="table-datatable">
                ...
                <tbody>
                  ...
                  $terkirim = mysqli_query($koneksi,"SELECT * FROM pesan WHERE pesan_jenis_penerima='$jenis' AND pesan_id_penerima='$id' ORDER BY pesan_id DESC");
