        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            <form class="form-horizontal">
              <?php 
              $id = $_GET['id'];
              $data = mysqli_query($koneksi,"SELECT * FROM proposal,pengurus WHERE proposal_id='$id' and proposal_pengurus=pengurus_id");
              while ($d = mysqli_fetch_array($data)) {
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" disabled class="form-control" value="<?php echo $d['pengurus_nama'] ?>">
                  </div>
                </div>
                <div class="form-group">
