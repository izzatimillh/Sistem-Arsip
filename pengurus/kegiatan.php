                ...
                <tbody>
                  ...
                  while($k = mysqli_fetch_array($kegiatan)){
                    ...
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-primary btn-sm" href="kegiatan_detil.php?id=<?php echo $k['kegiatan_id'] ?>"><i class="fa fa-search"></i> </a>
                        <a class="btn btn-warning btn-sm" href="kegiatan_edit.php?id=<?php echo $k['kegiatan_id'] ?>"><i class="fa fa-cog"></i> </a>
                        <a class="btn btn-danger btn-sm" href="kegiatan_hapus.php?id=<?php echo $k['kegiatan_id'] ?>"><i class="fa fa-trash"></i></a>
                      </td>
