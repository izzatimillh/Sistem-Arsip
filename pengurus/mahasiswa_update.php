...
if($pwd=="" && $filename==""){
	...
	if(!in_array($ext,$allowed) ) {
		...
		$x = $rand.'_'.$filename;
		mysqli_query($koneksi,"update mahasiswa set mahasiswa_nama='$nama',mahasiswa_fakultas='$fakultas',mahasiswa_jurusan='$jurusan',mahasiswa_alamat='$alamat',mahasiswa_alamat_sekarang='$alamat_sekarang',mahasiswa_no_telpon='$no_telpon',mahasiswa_no_wa='$no_wa',mahasiswa_no_ortu='$no_ortu',mahasiswa_agama='$agama',mahasiswa_foto='$x' where mahasiswa_id='$id'");
	header("location:mahasiswa.php");
	}
}elseif($filename==""){
	...
	if(!in_array($ext,$allowed) ) {
		...
		move_uploaded_file($_FILES['foto']['tmp_name'], '../gambar/mahasiswa/'.$rand.'_'.$filename);
		$x = $rand.'_'.$filename;
		mysqli_query($koneksi,"update mahasiswa set mahasiswa_nama='$nama',mahasiswa_fakultas='$fakultas',mahasiswa_jurusan='$jurusan',mahasiswa_alamat='$alamat',mahasiswa_alamat_sekarang='$alamat_sekarang',mahasiswa_no_telpon='$no_telpon',mahasiswa_no_wa='$no_wa',mahasiswa_no_ortu='$no_ortu',mahasiswa_agama='$agama',mahasiswa_foto='$x',mahasiswa_password='$password' where mahasiswa_id='$id'");
	header("location:mahasiswa.php");
	}
}
