            ...
            while($s = mysqli_fetch_array($stock)){
              ...
              <form action="stock_update.php" method="post">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="item_code" required="required" value="<?php echo $s['stock_item_code'] ?>">
                </div>
                <div class="form-group">
                  <label>Section</label>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="loc_code" required="required" value="<?php echo $s['stock_loc_code'] ?>">
                </div>
                <div class="form-group">
                  <label>Process Code</label>
                  <input type="text" class="form-control" name="process_code" required="required" value="<?php echo $s['stock_process_code'] ?>">
                </div>
                <div class="form-group">
                  <label>QTY Theory</label>
                  <input type="text" class="form-control" name="qty_theory" required="required" value="<?php echo $s['stock_qty_theory'] ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label>Date</label>
                  <input type="date" class="form-control" name="date" required="required" value="<?php echo $s['stock_date'] ?>">
                </div>
                <div class="form-group">
                  <label>Idouhyo No</label>
                  <input type="text" class="form-control" name="idouhyo_no" required="required" value="<?php echo $s['stock_idouhyo_no'] ?>">
                </div>
                <div class="form-group">
